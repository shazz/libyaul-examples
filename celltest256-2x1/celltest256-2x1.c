...
#ifdef PN_2x1_1WORD_AUX_256
    uint16_t _nbg0_cell_data_number = VDP2_PN_CONFIG_1_CHARACTER_NUMBER((uint32_t)VRAM_ADDR_4MBIT(0, 0x4000));
    uint16_t _nbg0_palette_number = VDP2_PN_CONFIG_1_PALETTE_NUMBER(CRAM_MODE_1_OFFSET(0, 0, 0));
#endif       
#ifdef PN_2x1_1WORD_NOAUX_256
    uint16_t _nbg0_cell_data_number = VDP2_PN_CONFIG_0_CHARACTER_NUMBER((uint32_t)VRAM_ADDR_4MBIT(0, 0x4000));
    uint16_t _nbg0_palette_number = VDP2_PN_CONFIG_1_PALETTE_NUMBER(CRAM_MODE_1_OFFSET(0, 0, 0));
#endif     
#ifdef PN_2x1_2WORDS_256 
    uint16_t _nbg0_cell_data_number = VDP2_PN_CONFIG_4_CHARACTER_NUMBER((uint32_t)VRAM_ADDR_4MBIT(0, 0x4000));
