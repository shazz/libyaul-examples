...
#include "shmup_back_streched.h"
#include "shmup_sprite_cell.h"

#define PLANE2_PNT  shmup_back_streched_pattern_name_table
#define PLANE2_CD   shmup_back_streched_cell_data
#define PLANE2_CP   shmup_back_streched_cell_palette

#define PLANE0_PNT  shmup_sprite_cell_pattern_name_table
#define PLANE0_CD   shmup_sprite_cell_cell_data
#define PLANE0_CP   shmup_sprite_cell_cell_palette
...
static int16_t g_scroll_back = 0;   
...
int main(void)
{
        ...
        while (true) 
        {
                ...
                uint8_t val = g_scroll_sprite_x/3;  
                if(val > 0x1F) val = 0x1F;
                g_cc_NBG2 = val;
                    
                g_scroll_back += val>>2;
                vdp2_scrn_scv_x_set(SCRN_NBG2, g_scroll_back, 0);
                
                vdp2_scrn_scv_x_set(SCRN_NBG0, -g_scroll_sprite_x, 0);
                vdp2_scrn_scv_y_set(SCRN_NBG0, g_scroll_sprite_y, 0);
